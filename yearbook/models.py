...
class Student(models.Model):
    ...
    your_choice_photo = models.ImageField(upload_to='your_choice_photos/2025/', blank=True, null=True, verbose_name="Kendi Seçtiği Fotoğraf")
    def __str__(self):
        return f"Dr. Adayı {self.first_name} {self.last_name}"

    class Meta:
        verbose_name = "2025 Dönemi Tıp fakültesi Mezunu"
        verbose_name_plural = "2025 Dönemi Tıp fakültesi Mezunları"
